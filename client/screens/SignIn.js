...
const SignIn = ({navigation}) => {
    ...
    return (
        <KeyboardAvoidingView contentCotainerStyle={styles.container}>
            ...
            <View style={styles.imageContainer}>
                ...
                <Text style={{ fontSize: 12, textAlign: 'center' }}>
                    Not yet registered? {""}
                    <Text style={{color:'darkred' , fontWeight:'bold'}} onPress={() => navigation.navigate("SignUp")}>Sign Up</Text></Text>
